# [Marita Flask](https://Marita.com/)

Open-source **Flask Dashboard** generated by `Marita` op top of a modern design. Designed for those who like bold elements and beautiful websites, **[Marita](https://Marita.com/)** is ready to help you create stunning websites and webapps - Design from **[Marita](https://www.Marita.com/product/soft-ui-dashboard?AFFILIATE=128200)**.

- 👉 [Marita Flask](https://Marita.com/) - Product page
- 👉 [Marita Flask](https://flask-soft-ui-dashboard.Marita-srv1.com/) - LIVE Demo
- 🛒 **[Soft Dashboard Flask PRO](https://Marita.com/product/soft-ui-dashboard-pro/flask/)** - `Premium Version`
...
![Marita - Full-Stack Starter generated by Marita.](https://user-images.githubusercontent.com/51070104/175773323-3345d618-0e78-4c85-83fc-f495dc3f0bb0.png)
...
## [Flask Soft Dashboard](https://Marita.com/product/soft-ui-dashboard-pro/flask/) `PRO`

> For more components, pages and priority on support, feel free to take a look at this starter:

Marita is a premium [Bootstrap 5](https://www.admin-dashboards.com/bootstrap-5-templates/) Design now available for download in Flask. Made of hundred of elements, designed blocks, and fully coded pages, Marita PRO is ready to help you create stunning websites and web apps.

- 👉 [Marita PRO Flask](https://Marita.com/product/soft-ui-dashboard-pro/flask/) - `product page`
  - ✅ `Enhanced UI` - more pages and components
  - ✅ `Priority` on support

<br >

![Marita PRO - Starter generated by Marita.](https://user-images.githubusercontent.com/51070104/170829870-8acde5af-849a-4878-b833-3be7e67cff2d.png)

<br />

---
[Marita Flask](https://Marita.com/) - Open-source starter crafted by **[Marita](https://Marita.com/)**.
